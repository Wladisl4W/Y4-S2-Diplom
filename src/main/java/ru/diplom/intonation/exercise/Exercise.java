...
public record Exercise(String id, String title, List<Integer> notes, double secondsPerNote) {
    ...
    public static List<Exercise> beginners() {
        return List.of(
                new Exercise("ascending", "Лесенка вверх", List.of(60, 62, 64, 65, 67), 2.0),
                new Exercise("descending", "Лесенка вниз", List.of(67, 65, 64, 62, 60), 2.0),
                new Exercise("three_notes", "Пирамидка", List.of(60, 62, 64, 62, 60), 2.0),
                new Exercise("triad", "Арпеджио", List.of(60, 64, 67, 64, 60), 2.0)
        );
    }
}
